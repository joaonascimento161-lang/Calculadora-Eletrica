...
if (numFaixas === 4) {
    let faixa1 = parseInt(prompt("Digite a cor da primeira faixa (0-9): "));
    let faixa2 = parseInt(prompt("Digite a cor da segunda faixa (0-9): "));
    let multiplicador = parseInt(prompt("Digite a cor do multiplicador (0-9): "));
    let tolerancia = parseInt(prompt("Digite a cor da tolerância (10-11): "));
    ...
    let faixa1 = parseInt(prompt("Digite a cor da primeira faixa (0-9): "));
    let faixa2 = parseInt(prompt("Digite a cor da segunda faixa (0-9): "));
    let faixa3 = parseInt(prompt("Digite a cor da terceira faixa (0-9): "));
    let multiplicador = parseInt(prompt("Digite a cor do multiplicador (0-9): "));
    let tolerancia = parseInt(prompt("Digite a cor da tolerância (10-11): "));
